 ...
 <script type="text/javascript">
  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> <i class="fas fa-stream"></i> Divisi</h1>
          </div> 
		<div class="col-sm-6">
            <div class="float-right">
              <button class="btn btn-sm btn-outline-danger" onclick="location.href = 'index.php';"><i class="fa fa-reply"></i> Kembali</button>
              <button type="button" onclick="location.href = './?p=divisi&aksi=tambah';" class="btn btn-sm btn-outline-primary"> <i class="fa fa-plus"></i> Tambah</a>                  
...
$(document).ready(function() {
        ...
        'columnDefs': [
            {
                ...
                'render': function(data, type, full, meta) {
                    return `
                        <a type="button" class="btn btn-xs btn-outline-primary" href="?p=divisi&aksi=edit&kode=${data}">
    ...
    $(document).on('click', '.btn-delete', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        var deleteUrl = `module/divisi/hapus.php?kode=${id}`;
